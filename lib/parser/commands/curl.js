...
exports.parseCommand = common.commonParseCommand(optionsParser, defaultComponentData, {
    string: function (component, str) {
        component.parameters.url = str;
    }
});

exports.parseComponent = common.commonParseComponent(cUrlData.flagOptions, cUrlData.selectorOptions, cUrlData.parameterOptions);
