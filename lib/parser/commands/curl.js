...
var cUrlData = new _common_imports_1.parserModule.ParserData(config);
var optionsParser = _common_imports_1.$.optionParserFromConfig(config);
_common_imports_1.$.generate(optionsParser);
var CurlComponent = (function (_super) {
    __extends(CurlComponent, _super);
    function CurlComponent() {
...
exports.CurlComponent = CurlComponent;
...
exports.parseCommand = _common_imports_1.common.commonParseCommand(optionsParser, defaultComponentData, {
    string: function (component, str) { component.parameters.url = str; }
});
exports.parseComponent = _common_imports_1.common.commonParseComponent(cUrlData.flagOptions, cUrlData.selectorOptions, cUrlData.parameterOptions);
exports.VisualSelectorOptions = cUrlData.visualSelectorOptions;
exports.componentClass = CurlComponent;
