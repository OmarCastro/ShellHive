...
var sortData = new _common_imports_1.parserModule.ParserData(config);
var optionsParser = {
    shortOptions: {
        ...
        k: _common_imports_1.$.setParameter(parameters.key.name),
    ...
    longOptions: {
        "ignore-leading-blanks": _common_imports_1.$.sameAs('b'),
        "dictionary-order": _common_imports_1.$.ignore,
        "ignore-case": _common_imports_1.$.sameAs('f'),
        "general-numeric": _common_imports_1.$.sameAs('g'),
        "ignore-nonprinting": _common_imports_1.$.sameAs('i'),
        "month-sort": _common_imports_1.$.sameAs('M'),
        "human-numeric-sort": _common_imports_1.$.sameAs('h'),
        "numeric-sort": _common_imports_1.$.sameAs('n'),
        "unique": _common_imports_1.$.sameAs('u')
    }
};
