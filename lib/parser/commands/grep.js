...
var optionsParser = {
    ...
    longOptions: {
        "extended-regexp": _common_imports_1.$.sameAs("E"),
        "fixed-strings": _common_imports_1.$.sameAs("F"),
        "basic-regexp": _common_imports_1.$.sameAs("G"),
        "perl-regexp": _common_imports_1.$.sameAs("P"),
        "ignore-case": _common_imports_1.$.sameAs("i"),
        "invert-match": _common_imports_1.$.sameAs("v"),
        "word-regexp": _common_imports_1.$.sameAs("w"),
        "line-regexp": _common_imports_1.$.sameAs("x")
    }
};
...
var grepCommandData = new _common_imports_1.parserModule.ParserData(config);
