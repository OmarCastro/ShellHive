...
var dateData = new _common_imports_1.parserModule.ParserData(config);
var optionsParser = _common_imports_1.$.optionParserFromConfig(config);
optionsParser.shortOptions['d'] = _common_imports_1.$.setParameter(config.parameters.date.name);
